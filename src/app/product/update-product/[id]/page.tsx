...
export default function Page({
  ...
  const setValueofFormData = () => {
    if (prodData) {
      ...
      setValue("color", prodData?.productColor);
      setValue("size", prodData?.productSize);
    }
  };
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    const updatedData: Inputs = {
      ...
      color:
        data.color !== prodData?.productColor
          ? data.color
          : prodData?.productColor,
      size:
        data.size !== prodData?.productSize ? data.size : prodData?.productSize,
      categoryID:
          ...
          >
            ...
            <div className="form-control w-full max-w-full">
              ...
              <select
                ...
                className="select select-bordered select-accent text-white"
              >
